...
export const SOCKET_EVENT_TYPE = {
    ...
    COMPONENT_ADDED_TO_EXHIBIT: 'COMPONENT_ADDED_TO_EXHIBIT',
    COMPONENT_REMOVED_FROM_EXHIBIT: 'COMPONENT_REMOVED_FROM_EXHIBIT',
    COMPONENT_CONNECTED: 'COMPONENT_CONNECTED',
    COMPONENT_DISCONNECTED: 'COMPONENT_DISCONNECTED',
    COMPONENT_PROPERTY_RECEIVED: 'COMPONENT_PROPERTY_RECEIVED',
} as const;

export type SocketEventType = ObjectValues<typeof SOCKET_EVENT_TYPE>;
